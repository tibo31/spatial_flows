...
##### Transform the explanatory variables to flows 
...
* **z**, the matrix containing the variables,
...
* **message**, print a message to indicate the ration of signal/noise. 
...
```{r, echo = F, eval = F}
Z_grid <- cbind(1, flows_grid$x_d, flows_grid$x_o, 
              as.numeric(W_grid_d %*% as(flows_grid$x_d, "sparseVector")), 
...
We use here the package **cartography** (Giraud and Lambert, 2016) for representing the flows.
